window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function GraphCanvas({ state, previewNodeId, onPreview, selectedNodeIds, candidateNodeId, disabled = false, labels: suppliedLabels, nodeColors }) {
			const locale = useLocale();
		...
		*/
		function HistoryRail({ entries, includedCount, previewCount, disabled = false, expanded = false, onSelect, onActiveChange }) {
			const locale = useLocale();
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsxs)("header", {
					...
					children: [(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [(0, react_jsx_runtime.jsxs)("span", { children: [label, " Context"] }), (0, react_jsx_runtime.jsx)("code", {
