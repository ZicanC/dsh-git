window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function ChatHistoryPreview({ response, orderedNodeIds, labels, candidateNodeId, activeNodeId = null, loading, error, loadImage }) {
			const locale = useLocale();
			...
			(0, react.useEffect)(() => {
				...
				if (element === void 0 || typeof element.scrollIntoView !== "function") return;
					...
					children: [
						response.turns.map((turn, index) => {
							...
							return (0, react_jsx_runtime.jsxs)("section", {
								...
								"data-node-id": nodeId,
								"data-rail-active": nodeId !== void 0 && nodeId === activeNodeId ? "" : void 0,
		...
		*/
		function HistoryRail({ entries, includedCount, previewCount, disabled = false, onSelect, onActiveChange }) {
			const locale = useLocale();
				...
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [graphOpen && (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("header", {
							...
							className: `dsh-git-chat-body ${rail.entries.length === 0 ? "" : "dsh-git-chat-body-rail"}`,
...
.dsh-git-graph-panel{min-width:0;min-height:0;overflow:hidden;background:color-mix(in srgb,var(--dsw-alias-label-primary) 2%,var(--dsw-alias-bg-base))}
...
/* ── Conversation trail rail ──
   ...
   Unselected graph nodes do not enter this rail. A pointed dash stretches into
   its own PA/title row; it does not open a second list or an answer-preview card. */
