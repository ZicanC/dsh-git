		...
		*/
		function ComposerDiscardAction({ useTray }) {
			...
			return (0, react_jsx_runtime.jsx)("button", {
				...
				type: "button",
				disabled: model.busy,
				title: localized("Context 有未 Merge 的更改。官方输入框已暂停，以免发送到原 Session。", "Context has unmerged changes. The official composer is paused to avoid sending to the source Session.", locale),
		...
		function ContextTray({ state, selectedIds, candidateId, busy, error, dirty, overLimit, onMove, onMoveEnd, onRemove, onMerge }) {
			const locale = useLocale();
			...
			const candidateNode = candidateId === null || selectedIds.includes(candidateId) ? void 0 : state.nodes[candidateId];
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("strong", { children: "Context Tray" }), (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [
								selectedIds.length,
								" PA",
								candidateNode === void 0 ? "" : localized(" + 1 预览", " + 1 preview", locale),
								" · ",
						...
						children: [(0, react_jsx_runtime.jsx)("button", {
							...
							children: busy ? localized("正在创建…", "Creating…", locale) : "Merge"
					...
					id: detailsId,
					children: [selectedIds.length === 0 && candidateNode === void 0 ? null : (0, react_jsx_runtime.jsxs)("div", {
						...
						}), candidateNode === void 0 || candidateId === null ? null : (0, react_jsx_runtime.jsxs)("span", {
				...
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							candidateId === null ? null : (0, react_jsx_runtime.jsx)("aside", {
...
.dsh-git-button.dsh-git-tray-merge{min-height:24px;padding:2px 10px;border-radius:7px;font-size:12px;line-height:18px}
...
.dsh-git-candidate-note{position:absolute;z-index:3;right:10px;top:50%;transform:translateY(-50%);max-width:min(180px,26%);padding:8px 10px;border:1px dashed var(--dsw-alias-state-success-primary);border-radius:10px;background:color-mix(in srgb,var(--dsw-alias-state-success-primary) 8%,var(--dsw-alias-bg-base));color:var(--dsw-alias-state-success-primary);box-shadow:0 2px 10px rgb(0 0 0/.08);font:var(--dsw-font-xs-13);line-height:1.5}
...
@media(max-width:700px){.dsh-git-workbench{grid-template-columns:1fr;grid-template-rows:minmax(300px,48%) minmax(300px,1fr)}.dsh-git-branch-left{border-right:0;border-bottom:1px solid var(--dsw-alias-border-l2)}.dsh-git-chat-history{padding:12px}}
`;
		//#endregion
