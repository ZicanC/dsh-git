...
export declare const MERGE_LINEAGE_EVENT = "dsh-git/merge";
...
export declare function mergeLineageEvent(sources: readonly HistoryTurnSource[], seq: number, time: number): SessionEvent<'dsh-git/merge'>;
/** Recover merge lineage from a Session log, or `undefined` for an ordinary Session. */
export declare function readMergeLineage(events: readonly SessionEvent[]): MergeLineage | undefined;
