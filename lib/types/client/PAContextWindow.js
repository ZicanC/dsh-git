...
export function PAContextWindow({ state, nodeId, label, selected, disabled, onAdd, onRemove, onClose, }) {
    ...
    return _jsxs("section", { id: "dsh-git-pa-context-window", className: "dsh-git-context-window", "aria-label": "PA Context Window", children: [_jsxs("header", { className: "dsh-git-heading", children: [_jsxs("span", { children: [label, " Context"] }), _jsx("button", { className: "dsh-git-close", type: "button", "aria-label": localized('关闭 PA Context Window', 'Close PA Context Window', locale), onClick: onClose, children: "\u00D7" })] }), _jsxs("div", { className: "dsh-git-inspector", children: [_jsx("h3", { children: node.prompt || localized('（无文字问题）', '(No text prompt)', locale) }), _jsxs("div", { className: "dsh-git-node-hash", children: [_jsx("span", { children: "HASH" }), _jsx("code", { children: nodeHash(node.id) })] }), _jsxs("section", { className: "dsh-git-context-history", "aria-label": localized('回答时使用的 Context', 'Context used for this answer', locale), children: [_jsx("span", { className: "dsh-git-message-label", children: localized('回答时使用的 CONTEXT', 'CONTEXT USED FOR THIS ANSWER', locale) }), node.contextManifest.length === 0
                                ...
                                : _jsx("ol", { children: node.contextManifest.map(contextId => {
                                    ...
                                    }) })] }), _jsxs("div", { className: "dsh-git-message", children: [_jsx("span", { className: "dsh-git-message-label", children: "PROMPT" }), _jsx(MarkdownText, { text: node.prompt || localized('（无文字问题）', '(No text prompt)', locale) })] }), _jsxs("div", { className: "dsh-git-message", children: [_jsx("span", { className: "dsh-git-message-label", children: "ANSWER" }), _jsx(MarkdownText, { text: node.answer || localized('（没有文字回答）', '(No text answer)', locale) })] }), _jsx("button", { className: `dsh-git-button ${selected ? '' : 'dsh-git-button-primary'}`, type: "button", disabled: disabled, onClick: selected ? onRemove : onAdd, children: selected
