...
export interface ProjectConnection {
    readonly rpc: {
        call(channel: string, endpoint: string, payload: unknown, signal?: AbortSignal): Promise<ProjectRpcResult>;
        handle(channel: string, handler: (endpoint: string, payload: unknown, signal: AbortSignal) => Promise<ProjectRpcResult>, options: {
